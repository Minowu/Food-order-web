...
if (isset($_SESSION['giohang']) && !empty($_SESSION['giohang'])) {
        ...
        <tbody>
            ...
            foreach ($_SESSION['giohang'] as $cart_item) {
                ...
                if ($row) {
                    ...
                    $giasp = $row['sanpham_gia'];
                    $thanhtien = $soluong * $giasp; // Tính thành tiền
                    $tongtien+=$thanhtien;
                    echo "<tr>";
                    echo "<td>$stt</td>";
                    ...
                    echo "<td>" . number_format($giasp, 3, '.', '.') . " đ</td>";
                    echo "<td>" . number_format($thanhtien, 3, '.', '.') . " đ</td>";
    ...
    <?php
    echo "<p class='total'>Tổng tiền: " . number_format($tongtien, 3, '.', '.') . " đ</p>";
